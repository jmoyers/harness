...
void test('tui left-rail interactions drive repository fold, global shortcuts, and pointer dispatch paths', async () => {
  ...
  let actionRowKind: 'repository.edit' | 'project.close' | 'nim.open' = 'repository.edit';
  ...
  assert.equal(calls.includes('enter-nim'), true);
